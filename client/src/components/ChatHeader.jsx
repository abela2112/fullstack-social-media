...
const ChatHeader = ({ typing, socketConnected }) => {
    ...
    <ChatHeaderContainer>
      <Toolbar>
        ...
        <Box sx={{ flexGrow: 1 }}>
          ...
          {
            socketConnected && typing ? <Typography variant="body2" color="textSecondary">Typing...</Typography> : <Typography variant="body2" color="textSecondary">
